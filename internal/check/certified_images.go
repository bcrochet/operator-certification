...
func (p *certifiedImagesCheck) Validate(ctx context.Context, imgRef knex.ImageReference) (bool, error) {
...
func (p *certifiedImagesCheck) Metadata() knex.Metadata {
...
func (p *certifiedImagesCheck) Help() knex.HelpText {
