...
import (
	...
	"github.com/opdev/operator-certification/internal/openshift"
...
var _ knex.Check = &DeployableByOlmCheck{}
...
func (p *DeployableByOlmCheck) Validate(ctx context.Context, bundleRef knex.ImageReference) (bool, error) {
...
func (p *DeployableByOlmCheck) operatorMetadata(ctx context.Context, bundleRef knex.ImageReference) (*operatorData, error) {
...
func (p *DeployableByOlmCheck) Metadata() knex.Metadata {
...
func (p *DeployableByOlmCheck) Help() knex.HelpText {
