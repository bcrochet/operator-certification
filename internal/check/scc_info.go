...
var _ knex.Check = &securityContextConstraintsInCSV{}
...
func (p *securityContextConstraintsInCSV) Validate(ctx context.Context, bundleRef knex.ImageReference) (bool, error) {
...
func (p *securityContextConstraintsInCSV) Metadata() knex.Metadata {
...
func (p *securityContextConstraintsInCSV) Help() knex.HelpText {
