...
var _ knex.Check = &ScorecardBasicSpecCheck{}
...
func (p *ScorecardBasicSpecCheck) Validate(ctx context.Context, bundleRef knex.ImageReference) (bool, error) {
...
func (p *ScorecardBasicSpecCheck) Metadata() knex.Metadata {
...
func (p *ScorecardBasicSpecCheck) Help() knex.HelpText {
	if p.fatalError {
