...
var _ knex.Check = &ValidateOperatorBundleCheck{}
...
func (p *ValidateOperatorBundleCheck) Validate(ctx context.Context, bundleRef knex.ImageReference) (bool, error) {
...
func (p *ValidateOperatorBundleCheck) Metadata() knex.Metadata {
...
func (p *ValidateOperatorBundleCheck) Help() knex.HelpText {
